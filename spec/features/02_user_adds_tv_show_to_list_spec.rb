...
# [X]  The genre must be one of the following: Action, Mystery, Drama, Comedy, Fantasy
# [X]  The Show is added to the list of favorite shows.
# [X-ish]  If any of the above criteria is left blank, the form should be re-displayed with the failing validation message
...
feature "user adds a new TV show" do
  ...
  scenario "fails to add a show with invalid information and stays on the same page" do
    visit "/television_shows/new"
